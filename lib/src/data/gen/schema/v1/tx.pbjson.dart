...
const MsgCreateSchema$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fields', '3': 3, '4': 3, '5': 11, '6': '.sonrio.sonr.schema.SchemaField', '10': 'fields'},
...
final $typed_data.Uint8List msgCreateSchemaDescriptor = $convert.base64Decode('Cg9Nc2dDcmVhdGVTY2hlbWESGAoHY3JlYXRvchgBIAEoCVIHY3JlYXRvchIUCgVsYWJlbBgCIAEoCVIFbGFiZWwSNwoGZmllbGRzGAMgAygLMh8uc29ucmlvLnNvbnIuc2NoZW1hLlNjaGVtYUZpZWxkUgZmaWVsZHMSQQoIbWV0YWRhdGEYBCADKAsyJS5zb25yaW8uc29uci5zY2hlbWEuTWV0YWRhdGFEZWZpbnRpb25SCG1ldGFkYXRh');
