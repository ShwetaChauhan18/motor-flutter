...
class ConfigRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConfigRequest', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.base.node.v1beta1'), createEmptyInstance: create)
...
class ConfigResponse extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'ConfigResponse', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'cosmos.base.node.v1beta1'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'minimumGasPrice')
    ..hasRequiredFields = false
  ;
...
class ServiceApi {
  ...
  $async.Future<ConfigResponse> config($pb.ClientContext? ctx, ConfigRequest request) {
    var emptyResponse = ConfigResponse();
    return _client.invoke<ConfigResponse>(ctx, 'Service', 'Config', request, emptyResponse);
  }
}
